...
try:
    ...
    from stock_data import store_to_csv, get_stock_data
...
class Template:
    def __init__(
        ...
        self.output_stock_id = output_stock_id
        ...
        self.data_years = int(period.rstrip('y'))
        self.data_period_label = f'{self.data_years}year'

        self.strategy_symbols = [f'{self.output_stock_id}_{self.data_period_label}']
    ...
    def _ensure_data(self):
        ...
        for symbol in self.strategy_symbols:
            if not os.path.exists(os.path.join(self.csv_dir_path, f"{symbol}.csv")):
                ...
                data = get_stock_data(self.index_symbol, self.data_years)
                store_to_csv(self.output_stock_id, self.data_period_label, data)
    ...
    def run(self) -> Dict:
        ...
        results = tearsheet.get_results(equity_df)
